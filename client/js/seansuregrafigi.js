Template.seanssuregrafigi.helpers({
...
Template.seanssuregrafig1.helpers({
	selected: function() {
		return Session.equals("selectedpatient", this.__originalId) ? "selected" : '';
	}
});
Template.seanssuregrafigi.onCreated(function() {
...
Template.seanssuregrafigi.events({
